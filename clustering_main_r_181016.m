...
%     n_m = 1 : 1 : l;
    ...
    [out check cg_result1 cg_result_g] = f_all_clustering_process_180404(CM,n_m,n_m_g,0.05);
...
%         clear pre_index
         ...
         for i = 1 : length(cg_result1)
             ...
             if pre_index(i) > 0
                ...
                [out_index_p(i) pre_index_p(i) cg_result1_p{i} cg_result_g_p{i}] = f_all_clustering_process_180404(CM_pp1{i},cg_result1{i},n_m_g,0.05);
